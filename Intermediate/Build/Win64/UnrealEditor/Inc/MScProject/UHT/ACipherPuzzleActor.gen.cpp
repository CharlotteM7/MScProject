...
// Begin Class AACipherPuzzleActor Function OnPuzzleSolved
static const FName NAME_AACipherPuzzleActor_OnPuzzleSolved = FName(TEXT("OnPuzzleSolved"));
void AACipherPuzzleActor::OnPuzzleSolved()
{
	UFunction* Func = FindFunctionChecked(NAME_AACipherPuzzleActor_OnPuzzleSolved);
	ProcessEvent(Func,NULL);
}
struct Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Cipher" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AACipherPuzzleActor, nullptr, "OnPuzzleSolved", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved_Statics::Function_MetaDataParams), Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved_Statics::FuncParams);
	}
	return ReturnFunction;
}
// End Class AACipherPuzzleActor Function OnPuzzleSolved
...
struct Z_Construct_UClass_AACipherPuzzleActor_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AACipherPuzzleActor_ActivatePuzzle, "ActivatePuzzle" }, // 303699984
		{ &Z_Construct_UFunction_AACipherPuzzleActor_ExitPuzzle, "ExitPuzzle" }, // 224126483
		{ &Z_Construct_UFunction_AACipherPuzzleActor_OnPuzzleSolved, "OnPuzzleSolved" }, // 551083540
...
struct Z_CompiledInDeferFile_FID_Masters_MScProject_Source_MScProject_ACipherPuzzleActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AACipherPuzzleActor, AACipherPuzzleActor::StaticClass, TEXT("AACipherPuzzleActor"), &Z_Registration_Info_UClass_AACipherPuzzleActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AACipherPuzzleActor), 2439109077U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Masters_MScProject_Source_MScProject_ACipherPuzzleActor_h_1932710135(TEXT("/Script/MScProject"),
